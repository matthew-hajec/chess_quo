defmodule EasyChessWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EasyChessWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EasyChessWeb.Gettext, "errors", msg, opts)
    end
  end
